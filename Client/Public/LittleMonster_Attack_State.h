...
class LittleMonster_Attack_State : public State
{
private:
    LittleMonster_Attack_State();
public:
    virtual ~LittleMonster_Attack_State();
public:
    HRESULT Initialize();
public:
...
public:
    static  shared_ptr<LittleMonster_Attack_State> Create();
