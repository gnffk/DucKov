...
class LittleMonster_HAND_UP_AND_LEFT_State : public State
{
private:
    LittleMonster_HAND_UP_AND_LEFT_State();
public:
    virtual ~LittleMonster_HAND_UP_AND_LEFT_State();
public:
    HRESULT Initialize();
public:
...
public:
    static  shared_ptr<LittleMonster_HAND_UP_AND_LEFT_State> Create();
