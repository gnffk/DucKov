...
class Boss_State_UI : public UIObject
{
private:
    Boss_State_UI(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
    Boss_State_UI(const Boss_State_UI& Prototype);

public:
    virtual ~Boss_State_UI();
...
public:
    static unique_ptr<Boss_State_UI> Create(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
