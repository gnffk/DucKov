...
class Boss_HAND_UP_AND_WALK_State : public State
{
private:
    Boss_HAND_UP_AND_WALK_State();
public:
    virtual ~Boss_HAND_UP_AND_WALK_State();
public:
    HRESULT Initialize();
public:
...
public:
    static  shared_ptr<Boss_HAND_UP_AND_WALK_State> Create();
