...
class BossMonster_Page2FSM final : public FSM
{
public:
    enum BOSS_STATE
    {
...
private:
    BossMonster_Page2FSM();

public:
    virtual ~BossMonster_Page2FSM() = default;
...
public:
    static  shared_ptr<BossMonster_Page2FSM> Create(uint32_t* eModelState);
};
