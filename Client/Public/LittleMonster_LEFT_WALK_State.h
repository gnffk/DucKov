...
class LittleMonster_LEFT_WALK_State : public State
{
private:
    LittleMonster_LEFT_WALK_State();
public:
    virtual ~LittleMonster_LEFT_WALK_State();
public:
    HRESULT Initialize();
public:
...
public:
    static  shared_ptr<LittleMonster_LEFT_WALK_State> Create();
