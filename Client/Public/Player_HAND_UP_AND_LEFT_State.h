...
class Player_HAND_UP_AND_LEFT_State : public State
{
private:
    Player_HAND_UP_AND_LEFT_State();
public:
    virtual ~Player_HAND_UP_AND_LEFT_State();
public:
    HRESULT Initialize();
public:
...
public:
    static  shared_ptr<Player_HAND_UP_AND_LEFT_State> Create();
