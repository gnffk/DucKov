...
HRESULT MainUI::Initialize(void* pArg)
{
    ...
    //    TEXT("Prototype_Com_Texture_MainUI_Back"),
    //    { 200.f, 100.f },
    //    { 300.f, 80.f },
    //    0.1f)))
    //    return E_FAIL;
    ...
    //if (FAILED(Add_UIRect(
    //    TEXT("Prototype_Com_Texture_HPBar"),
    //    { 200.f, 100.f },
    //    { 250.f, 20.f },
    //    0.0f)))
    //    return E_FAIL;

    if (FAILED(Add_UIRect(TEXT("1"), TEXT("1"), TEXT("Prototype_Com_Texture_Icon"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("1Num"), TEXT("1Num"), TEXT("Prototype_Com_Texture_Number"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("2"), TEXT("2"), TEXT("Prototype_Com_Texture_Icon"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("2Num"), TEXT("2Num"), TEXT("Prototype_Com_Texture_Number"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("3"), TEXT("3"), TEXT("Prototype_Com_Texture_Icon"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("3Num"), TEXT("3Num"), TEXT("Prototype_Com_Texture_Number"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("4"), TEXT("4"), TEXT("Prototype_Com_Texture_Icon"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("4Num"), TEXT("4Num"), TEXT("Prototype_Com_Texture_Number"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("5"), TEXT("5"), TEXT("Prototype_Com_Texture_Icon"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("5Num"), TEXT("5Num"), TEXT("Prototype_Com_Texture_Number"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;

    if (FAILED(Add_UIRect(TEXT("6"), TEXT("6"), TEXT("Prototype_Com_Texture_Icon"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("6Num"), TEXT("6Num"), TEXT("Prototype_Com_Texture_Number"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("7"), TEXT("7"), TEXT("Prototype_Com_Texture_Icon"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("7Num"), TEXT("7Num"), TEXT("Prototype_Com_Texture_Number"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("8"), TEXT("8"), TEXT("Prototype_Com_Texture_Icon"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
    if (FAILED(Add_UIRect(TEXT("8Num"), TEXT("8Num"), TEXT("Prototype_Com_Texture_Number"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;

    if (FAILED(Add_UIRect(TEXT("v"), TEXT("v"), TEXT("Prototype_Com_Texture_Icon"), {50.f, 50.f}, {64.f, 64.f}, 0.0f)))
        return E_FAIL;
...
void MainUI::Priority_Update(_float fTimeDelta)
{
}
...
HRESULT MainUI::Render_UIRect(UI_RECT& UI)
{
...
unique_ptr<MainUI> MainUI::Create(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
{
    unique_ptr<MainUI> pInstance = unique_ptr<MainUI>(new MainUI(pDevice, pContext));

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX("Failed to Created : MainUI");
        return nullptr;
    }
...
shared_ptr<Prototype> MainUI::Clone(void* pArg)
{
    shared_ptr<MainUI> pInstance = shared_ptr<MainUI>(new MainUI(*this));

    if (FAILED(pInstance->Initialize(pArg)))
    {
        MSG_BOX("Failed to Cloned : MainUI");
        return nullptr;
    }
...
HRESULT MainUI::Save_UIRects(const wstring& strFilePath)
{
...
HRESULT MainUI::Load_UIRects(const wstring& strFilePath)
{
