...
namespace Engine
{
	...
	enum class RENDERGROUP { PRIORITY, NONBLEND, NONLIGHT, BLEND, EFFECT, UI, SHADOW, END };
	...
	enum CHANNELID
	{
		...
		EFFECT_Player_Walk,
		EFFECT_WALKPlayer,
		EFFECT_LITTLEMONSTER_HIT,
		EFFECT_LITTLEMONSTER_DIE,
		EFFECT_LITTLEMONSTER_ATTACK,
